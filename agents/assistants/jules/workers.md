...
Lookup cascade: shorthand → products/recipes/supplements table → resolve → log. Darla uses shorthand names — the worker resolves them from the database, never guesses.
