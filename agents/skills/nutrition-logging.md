...
Any time [redacted] asks to log a meal, snack, supplement, or individual food item.
...
[redacted] uses shorthand names. Before anything else, check the `shorthand` column:
...
When [redacted] reports a meal, check if supplements are due for that time of day per the supplement protocol. Compare what's been logged today against the protocol schedule.
...
## How to Parse [redacted]'s Messages

[redacted] types naturally. Translate into structured entries.
...
**Rules:**
- Use today's date unless [redacted] says otherwise
...
3. **Liver cycle check:** When logging lunch supplements or liver cycle items, surface how [redacted] is feeling to determine the combo.
...
Timing is a guideline. [redacted] may take supplements at any time based on her day. Do not flag "late" or "off schedule."
