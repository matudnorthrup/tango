...
When Darla describes a meal she didn't source (catered events, restaurant orders, takeout), estimate macros using FatSecret or browser lookup. Present the estimate clearly so she can correct if needed.
