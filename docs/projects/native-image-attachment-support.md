...
This means **downloading to a temp file + telling Claude Code the path** is the most robust approach. This is essentially Darla's workaround, but done properly.

## Recommended Architecture: Option A — Download + Read Tool

### Why Option A

- **Proven:** Darla's workaround confirms this works end-to-end
