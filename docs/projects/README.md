...
`docs/projects/` is a legacy home for project writeups that predate Linear as
the source of truth for active work.
...
- [`../retros/docs-project-cleanup-2026-05-30.md`](../retros/docs-project-cleanup-2026-05-30.md)
