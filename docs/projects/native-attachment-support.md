...
Darla's image-heavy workflow is the power-user validation case: 50-100 images per day, frequent `/new` resets, multi-day project continuation, and retrieval of older images without flooding the model context.
...
- Do not copy the Darla/Sage fork wholesale; use its failures and usage evidence as requirements.
...
- **Darla scenario:** high-volume image-heavy workflow validates multi-image, multi-day retrieval across `/new` resets and normal continuation.
...
Darla high-volume validation, 2026-06-02:

- The wt-2 profile seeded 128 ready image attachments for marker `tgo-586-darla-volume-1780408500000`, split across two simulated project days with 64 images per day and mixed screenshot, reference-photo, document-like, swatch, whiteboard, receipt, layout, and annotated-image categories.
...
| [TGO-586](https://linear.app/seaside-hq/issue/TGO-586/validate-darla-high-volume-multi-day-image-workflow) | Validation and ship | Validate high-volume image-heavy, multi-day retrieval without context flooding. |
