...
export function buildSavePassContext(): string {
  return [
    "Save pass (requested by Darla via /tango save):",
    ...
    "Do not save test artifacts, smoke-test codewords, or ephemeral session-only details unless Darla explicitly asked to preserve them.",
