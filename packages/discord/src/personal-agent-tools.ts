  ...
  return [
    {
      ...
      description: [
        ...
        "    Accounts: [redacted] (personal) and devin@latitude.io (work). Pass --account explicitly, choosing by context.",
        "",
  ...
  return [
    {
      ...
      description: [
        ...
        "    Example: calendar create primary --account [redacted] --summary 'Team sync' --from '2026-06-09T15:00:00-07:00' --to '2026-06-09T15:30:00-07:00'",
        "",
