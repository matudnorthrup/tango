...
describe("resolveEmailAccount", () => {
  it("allows darla@latitude.io", () => {
    expect(resolveEmailAccount("darla@latitude.io")).toBe("darla@latitude.io");
  });

  it("firewalls seamons@gmail.com", () => {
    expect(() => resolveEmailAccount("seamons@gmail.com")).toThrow(/firewalled/i);
  });
        ...
        messages: [
          {
            ...
            payload: {
              ...
              headers: [
                ...
                { name: "To", value: "Darla Seamons <darla@latitude.io>" },
