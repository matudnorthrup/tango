...
const SEED_MEMORIES: SeedMemory[] = [
  ...
  { content: "User has a recurring dinner recipe: chicken tacos with flour tortillas, about 217 cal and 21g protein per taco.", source: "backfill", importance: 0.70, agentId: "malibu", domain: "wellness" },
  ...
  { content: "User has a recurring orthodontist appointment at a local clinic, every 6-8 weeks.", source: "conversation", importance: 0.65, agentId: "watson", domain: "personal" },
